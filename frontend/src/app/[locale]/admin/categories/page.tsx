  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Product Categories</h2>
      </div>
      ...
      <div className="bg-white dark:bg-[#111111] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
        ...
        <form onSubmit={handleCreateCategory} className="mb-8">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Create New Category</label>
          <div className="flex gap-4">
            <input
              type="text"
              required
              placeholder="e.g. T-Shirts, Electronics, Sale"
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Existing Categories</h3>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 px-4 rounded-xl border border-dashed border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50">
              ...
              <p className="text-gray-500 dark:text-gray-400">Create your first category above to start organizing your products.</p>
            </div>
          ) : (
